...
router.post('/', (req, res, next) => {
    ...
    async (req, res) => {
        try {
            ...
            // Sau phản hồi, bắt đầu kiểm tra quá trình xử lý bằng setInterval tránh mất file và tạo file ZIP
            const intervalCheck = setInterval(async () => {
                ...
                if (allFilesExist) {
                    clearInterval(intervalCheck); // Dừng kiểm tra khi tất cả PDF đã có

                    // Tạo file ZIP chứa các PDF
